...
function Command({
    ...
    return (
        <CommandPrimitive
            data-slot="command"
            className={cn(
                "flex size-full flex-col overflow-hidden rounded-xl bg-gray-900 text-gray-100 border border-gray-800",
                className
            )}
            {...props}
        />
...
function CommandDialog({
    ...
    return (
        <Dialog {...props}>
            <DialogContent
                className={cn(
                    "fixed top-[20%] left-1/2 -translate-x-1/2 z-50 w-full max-w-lg overflow-hidden rounded-xl bg-gray-900 border border-gray-800 p-0 shadow-2xl",
                    className
                )}
